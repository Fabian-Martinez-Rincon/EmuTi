...
class MiVentana(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.next_button.grid(row=1, column=0, pady=10, padx=10, columnspan=2)  # Cambiado a la fila 1

        self.create_window_widgets()
        self.create_numeric_widgets()

        self.result_label = tk.Label(self, text="")
        self.result_label.grid(row=4, column=0, pady=10, padx=10, columnspan=2)  # Cambiado a la fila 4

        self.close_button = tk.Button(self, text="Cerrar", command=self.master.destroy)
        self.close_button.grid(row=5, column=0, pady=10, padx=10, columnspan=2)  # Cambiado a la fila 5

        self.index_label = tk.Label(self, text="Índice: 0")
        self.index_label.grid(row=6, column=0, pady=10, padx=10, columnspan=2)  # Cambiado a la fila 6

        self.create_custom_index_widgets()

    def create_window_widgets(self):
        self.window_label = tk.Label(self, text="Nombre de la Ventana")
        self.window_label.grid(row=2, column=0, pady=10, padx=10, columnspan=2)  # Cambiado a la fila 2

        self.window_entry = tk.Entry(self)
        self.window_entry.grid(row=3, column=0, pady=10, padx=10, columnspan=2)  # Cambiado a la fila 3

        self.show_window_button = tk.Button(self, text="Mostrar Valor", command=self.show_window_value)
        self.show_window_button.grid(row=4, column=0, pady=10, padx=10, columnspan=2)  # Cambiado a la fila 4

    def create_numeric_widgets(self):
        self.value_label = tk.Label(self, text="Valor numérico:")
        self.value_label.grid(row=5, column=0, pady=10, padx=10, columnspan=2)  # Cambiado a la fila 5

        self.value_entry = tk.Entry(self)
        self.value_entry.grid(row=6, column=0, pady=10, padx=10, columnspan=2)  # Cambiado a la fila 6

        self.show_numeric_button = tk.Button(self, text="Mostrar Valor", command=self.show_numeric_value)
        self.show_numeric_button.grid(row=7, column=0, pady=10, padx=10, columnspan=2)  # Cambiado a la fila 7

    def create_custom_index_widgets(self):
        self.custom_index_label = tk.Label(self, text="Personalizado:")
        self.custom_index_label.grid(row=8, column=0, pady=10, padx=10)  # Cambiado a la fila 8

        self.custom_index_entry = tk.Entry(self)
        self.custom_index_entry.grid(row=8, column=1, pady=10, padx=10)  # Mantenido en la fila 8

        self.update_custom_index_button = tk.Button(self, text="Actualizar Índice", command=self.update_custom_index)
        self.update_custom_index_button.grid(row=8, column=2, pady=10, padx=10)  # Mantenido en la fila 8
