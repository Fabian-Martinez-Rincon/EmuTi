...
class MyApp(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.file_button.grid(row=0, column=0, pady=10, padx=10)

        # Agrega la etiqueta file_label
        self.file_label = tk.Label(self, text="")
        self.file_label.grid(row=1, column=0, pady=10, padx=10)

        self.auto_button = tk.Button(self, text="Automático", command=self.automatic_operation)
        self.auto_button.grid(row=2, column=0, pady=10, padx=10)

        self.next_button = tk.Button(self, text="Siguiente", command=self.next_step)
        self.next_button.grid(row=3, column=0, pady=10, padx=10)
